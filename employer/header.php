				...
				<div class="header-widget">
					...
					<div class="header-notifications user-menu">
						<div class="header-notifications-trigger" id="online_or_not">
								...
								echo "
								<a href='#'><div class='user-avatar $text'><img src='../images/employer/profile/$picture' style='width:70px; height:40px' alt=''></div></a>
								";
								?>
						</div>
						...
						<div class="header-notifications-dropdown">
							...
							<div class="user-status">
								...
								?>
									<div class="user-name">
									<?php echo $firstname." ".$lastname; ?> <span>Employer</span>
									</div>
								</div>
