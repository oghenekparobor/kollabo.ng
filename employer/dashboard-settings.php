	...
	<div class="dashboard-content-container" data-simplebar>
		<div class="dashboard-content-inner" >
			...
			<div class="row">
							...
							<div class="row">
								...
								<div class="col-auto">
									<div class="avatar-wrapper" data-tippy-placement="bottom" title="Change Avatar">
										<img class="profile-pic" src="../images/employer/profile/<?php echo $picture; ?>" alt="" />
								...
								<div class="col">
									<div class="row">
										...
										<div class="col-xl-6">
											<div class="submit-field">
												<h5>Last Name</h5>
												<input type="text" name="lastname" class="with-border" value="<?php echo $lastname; ?>">
											</div>
										</div>
										...
										<div class="col-xl-6">
											...
											<div class="submit-field">
												...
												<div class="account-type">
													<div>
														<input type="radio" name="account-type-radio" id="employer-radio" value="employer" class="account-type-radio" checked/>
							...
							<li>
								<div class="row">
									...
									<div class="col-xl-6">
										<div class="submit-field">
											<h5>Nationality</h5>
											<select class=" with-border" data-size="7" name="place" title="Select Category">
				...
				<!-- Button -->
				<div class="col-xl-12">
					<button type="submit" name="account_setting" class="button ripple-effect big margin-top-30">Save Changes</button>
				</div>
